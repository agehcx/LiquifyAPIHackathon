 ...
 * acquisition lots Highest-In-First-Out. Pure: events must already be sorted
 * ascending by (timestamp, logIndex).
 *
 * The highest-cost lots are prioritized to minimize taxable gains.
 */
export function computeHifo(events: ClassifiedEvent[]): HifoResult {
